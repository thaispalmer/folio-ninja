	...
	public function actionContact()
	{
		...
		if(isset($_POST['ContactForm']))
		{
			...
			if($model->validate())
			{
				...
				mail(Yii::app()->params['contactEmail'],$subject,$model->message,$headers);
				Yii::app()->user->setFlash(TbHtml::ALERT_COLOR_SUCCESS,"<h4>All right!</h4> Thank you for contacting us. We will respond to you as soon as possible.");
				$this->refresh();
			}
		}
